...
![AICPA SOC Logo](/img/compliance/soc.png)

Customers can request access to the audit report.

## Security Scorecard

[![Security Scorecard Logo](/img/compliance/securityscorecard.png)](https://securityscorecard.com/security-rating/medplum.com?utm_medium=badge&utm_source=medplum.com&utm_campaign=seal-of-trust&utm_content=https://platform.securityscorecard.io/)
